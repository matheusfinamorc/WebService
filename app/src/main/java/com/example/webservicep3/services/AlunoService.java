package com.example.webservicep3.services;
...
public interface AlunoService {
    ...
    @GET("aluno/diff") // baseado na versao, pega a diferença de cada uma delas
    Call<AlunoSync> novos(@Header("datahora") String versao); // versao é baseada em data/hora
